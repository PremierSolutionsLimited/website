              ...
              <div className="flex items-center md:ml-12">
                {/* {themeVariable === "dark" ? (
                  ...
                  <Fragment>
                    <button
                      ...
                      className="text-base font-medium focus:outline-none text-gray-500 hover:text-gray-900"
                    >
                      <svg
                        className={"h-7 w-7"}
                        xmlns="http://www.w3.org/2000/svg"
                ...
                {/* <div className="relative text-gray-600">
                  <input
                    ...
                    placeholder="Search"
                    className={` ${
                      initialScrollPositionMoved ? "bg-gray-100" : "bg-white"
                    }  h-10 px-5 pr-10 rounded-full text-sm focus:outline-none`}
                  />
                  <button
                    type="submit"
