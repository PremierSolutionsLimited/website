...
export interface PersonalComponentProp {
  ...
  setHasValidLicense: React.Dispatch<React.SetStateAction<string>>;
  ...
  vehicleType: IType[];
  setVehicleType: React.Dispatch<React.SetStateAction<IType[]>>;
  hasHadAccident: string;
  setHasHadAccident: React.Dispatch<React.SetStateAction<string>>;
