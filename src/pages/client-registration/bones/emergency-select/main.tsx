...
import { MainComponentProp, EmergencyInputProp } from "../types";
    ...
    <React.Fragment>
      <div style={{ width: "100%" }} className={"pl-3"}>
        <button
          ...
          className={
            " flex justify-center focus:outline-none items-center py-2 rounded-md bg-gray-50 hover:bg-gray-100"
          }
        >
      ...
      <div style={{ height: "25vh" }} className="overflow-y-auto">
        {emergencyContact.map((contact: EmergencyInputProp, index: number) => (
          <React.Fragment key={index}>
            <div className="grid  grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 mb-2 pl-3 mt-2">
              <SingleSelectOption
                name={contact?.name}
