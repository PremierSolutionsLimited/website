    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" {...props}>
      <g id="freepik--background-complete--inject-39">
        ...
        <circle
          ...
          cy={213.34}
          r={13.61}
          transform="translate(-21.16 46.18) rotate(-6.37)"
          style={{
            fill: "#ebebeb",
          }}
        />
      ...
      <g id="freepik--Moon--inject-39">
        ...
        <rect
          ...
          height={11.29}
          rx={2.16}
          transform="translate(556.67 203.75) rotate(90)"
          style={{
            fill: "#ebebeb",
          }}
        />
      ...
      <g id="freepik--Planets--inject-39">
        <circle
          cx={370.95}
          cy={390.79}
          r={32.59}
          transform="translate(-167.05 361.14) rotate(-43.34)"
          style={{
            fill: "#455a64",
          }}
        />
        ...
        <circle
          ...
          cy={219.34}
          r={19.23}
          transform="translate(-58.55 86.01) rotate(-18.85)"
          style={{
            fill: "#ebebeb",
          }}
        />
        ...
        <circle
          ...
          cy={85.63}
          r={19.23}
          transform="translate(-25.04 41.35) rotate(-21.82)"
          style={{
            fill: "#FF725E",
          }}
        />
        ...
        >
          <path d="M113.16,91.22a22.73,22.73,0,0,0-6-3.74C103.34,85.8,93,84,88.17,81.54c-6.75-3.41-7.59-7.08-7.55-9a19.11,19.11,0,0,1,5.94-4.34c.48,1.94,2.28,8,13.49,12,5.79,2,11.33.67,13.21.21A19.13,19.13,0,0,1,113.16,91.22Z" />
          <path d="M105.3,101.71a19.26,19.26,0,0,1-24.11-2.43,15.3,15.3,0,0,1,3.45-1.37c5.17-1.26,10.87,1.22,13,2.38A11.27,11.27,0,0,0,105.3,101.71Z" />
          <path d="M112,94.11a5.21,5.21,0,0,1-.24.47c-.07.14-.14.28-.22.42-.18.31-.36.62-.55.92s-.34.54-.53.8l-.21.28a3.81,3.81,0,0,1-.24.32l-.24.32-.3.37-.31.35-.27.31c-.2.22-.41.43-.62.63h0c-1.2.36-2.8.2-5.15-.72-3.49-1.37-7.26-4.67-14-7.1a24.12,24.12,0,0,0-12.93-.83h0A19.14,19.14,0,0,1,76.68,79c1.23-.05,5.18.51,13.61,7.47a49.32,49.32,0,0,0,8.49,5.81C106,96.1,110.15,95,111.89,94.1H112Z" />
        </g>
        <g
          style={{
            opacity: 0.1,
        ...
        >
          <path d="M93.73,101.35c.34-.79,1.54-1,2.68-.52s1.79,1.53,1.45,2.31-1.55,1-2.68.52S93.39,102.13,93.73,101.35Z" />
          <path d="M99.18,100c.19-.44.9-.56,1.58-.26s1.08.9.89,1.34-.9.55-1.59.26S99,100.42,99.18,100Z" />
          <path d="M84.26,76.36c.29-.67,1.33-.86,2.33-.43s1.57,1.33,1.28,2-1.34.86-2.34.42S84,77,84.26,76.36Z" />
          <path d="M87.8,75.69a.84.84,0,0,1,1.13-.27.73.73,0,1,1-.56,1.29A.85.85,0,0,1,87.8,75.69Z" />
          <path d="M88.37,77.48a.53.53,0,0,1,.71-.16c.3.14.47.41.38.63a.54.54,0,0,1-.71.15C88.45,78,88.28,77.69,88.37,77.48Z" />
          <path d="M100.38,77.52a1.63,1.63,0,1,1,1,1.72A1.42,1.42,0,0,1,100.38,77.52Z" />
          <path d="M99.91,80.14a.76.76,0,0,1,1.39.61.76.76,0,0,1-1.39-.61Z" />
        </g>
      </g>
      <g id="freepik--Rocket--inject-39">
        <path
